...
namespace PISIAssessment.PISIService
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<ResponseService<string>> Login(string username, string password)
        {
            ...
            var user = await _context.Services
        ...
        public async Task<ResponseService<int>> Register(Service user, string password)
        {
        ...
        {
            if (await _context.Services.AnyAsync(u => u.Username.ToLower() == username.ToLower()))
            {
                return true;
            }
            return false;
        ...
        private string CreateToken(Service user)
        {
        ...
        // private void SetRefreshToken(Subscriber newRefreshToken)
        // {
